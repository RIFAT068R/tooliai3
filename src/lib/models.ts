...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    limits: {
      messagesPerDay: 300,
      imagesPerDay: 50,
      modelsAllowed: ['gpt-4.1-mini', 'gpt-4.1', 'gemini-2.0-flash', 'gemini-1.5-pro', 'gemini-1.5-flash', 'groq-llama-3.1-8b', 'groq-llama-3.1-70b', 'groq-mixtral-8x7b', 'cloudflare-llama-3.1-8b', 'cloudflare-mistral-7b', 'openrouter-claude-3-haiku', 'openrouter-llama-3-70b', 'blink-nano', 'blink-nano-pro'],
    },
  },
  {
    id: 'max',
